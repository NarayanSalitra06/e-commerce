  ...
  return (
    <footer className=" font-inter p-6 border-t border-[#0d0d0d33] border-opacity-20 border-solid ">
      ...
      <div className="container  mx-auto  border border-[#0d0d0d33] border-opacity-20 border-solid">
        <div className="grid md:grid-cols-[75%_25%] grid-cols-2  items-center w-full">
          ...
          <div className="w-full  mb-6 pb-0 lg:mb-0 border-r border-[#0d0d0d33] border-opacity-20 border-solid "> 
            ...
            <div className="flex items-start justify-start gap-x-[20px]">
              ...
              <div className="md:min-h-[15vw]">
                <div className="font-bold  mb-2 text-[#0d0d0d] text-[13px] font-inter">Help</div>
                <ul className='text-[11px] text-[#0d0d0dcc] font-inter'>
                  <li><a href="#" className="hover:underline  block mb-2">Help Center</a></li>
                  <li><a href="#" className="hover:underline  block mb-2">Careers</a></li>
                  <li><a href="#" className="hover:underline  block mb-2">Contact Us</a></li>
                  <li><a href="#" className="hover:underline  block mb-2">Shipping Info</a></li>
                  <li><a href="#" className="hover:underline  block mb-2">Track My Order</a></li>
                  <li><a href="#" className="hover:underline  block mb-2">Returns & Exchanges</a></li>
                </ul>
              </div>

              {/* More Section */}
              <div className="">
                <h3 className="font-bold  mb-2 text-[#0d0d0d] text-[13px] font-inter">More</h3>
                <ul className='text-[11px] text-[#0d0d0dcc] font-inter'>
                  <li><a href="#" className="hover:underline  block mb-2">Share The Look</a></li>
                  <li><a href="#" className="hover:underline  block mb-2">About Us</a></li>
                  <li><a href="#" className="hover:underline  block mb-2">Alphaland</a></li>
                  <li><a href="#" className="hover:underline  block mb-2">Summer Shredding</a></li>
                </ul>
              </div>

              {/* Address Section */}
              <div className="">
                <h3 className="font-bold  mb-2 text-[#0d0d0d] text-[13px] font-inter">Address</h3>
                <p className=" text-[11px] text-[#0d0d0dcc] font-inter"> <a href="#">
            ...
            <div className=" flex justify-between  md:min-h-[6.5vw] border-[#0d0d0d33] border-opacity-20 border-solid">
              <div className="w-1/2 border-r p-[20px] gap-[15px] border-[#0d0d0d33] flex flex-col items-center justify-center border-opacity-20 border-solid">
                ...
                <p className=" text-[10px] font-semibold text-[#0d0d0dcc] text-center  font-inter">© 2024 • Alphalete Athletics LLC • All Rights Reserved</p>
              </div>

              <div className="w-1/2 p-4 flex flex-col  items-start justify-start ">
                <h3 className="font-bold   text-[13px] text-[#0d0d0dcc] font-inter">Premium Workout Clothes & Athleisure</h3>
          ...
          <div className=" p-5 border-l border-[#0d0d0d33] border-opacity-20 border-solid">
            ...
            <h3 className="  text-[4vw] tracking-tighter leading-none text-[#444444] font-inter  font-black ">Stay   Connected</h3>
              <div className="mb-4">
                <input
                  type="tel"
      ...
      <div className="bg-white  text-center  border-t border-[#0d0d0d33] border-opacity-20 border-solid">
        <div className="text-[15vw] tracking-tight font-work-sans font-bold text-black line-clamp-none leading-none">ALPHALETE</div>
      </div>
      </div>
