      ...
      <footer className="bg-white md:mb-[12vw] mb-[75vw] w-full font-inter pt-0 border-t border-[#0d0d0d33] border-opacity-20 border-solid relative overflow-y-hidden">
        ...
        <div className="relative w-full border border-[#0d0d0d33] border-opacity-20 border-solid">
          <div className="flex flex-col lg:grid lg:grid-cols-[80%_20%] items-start w-full">
            {/* Right Container - Stay Connected Section */}
            <div className="w-full lg:border-l  order-1 lg:order-2 border-b lg:border-b-0 border-[#0d0d0d33] border-opacity-20 border-solid">
              <form className="p-8 lg:max-w-[300px]">
                ...
                <p className="text-[10px] text-[#5b5b5b] font-work-sans">
                  ...
                  &{" "}
                  <a href="#" className="underline">ToS</a>
                </p>
              </form>
            </div>
            ...
            <div className="w-full lg:border-r border-[#0d0d0d33] border-opacity-20 border-solid order-2 lg:order-1">
              ...
              <div className="p-8 lg:pb-40 border-b border-[#0d0d0d33] border-opacity-20 border-solid">
                <div className="lg:flex lg:space-x-4">
                  {/* Help Section */}
                  <div className="mb-8 lg:mb-0 border-b lg:border-b-0 border-[#0d0d0d33] border-opacity-20 border-solid pb-8 lg:pb-0">
              ...
              {/* Bottom Section */}
              <div className="p-8">
                <div className="flex flex-col lg:flex lg:flex-row lg:justify-between items-start relative">
                  {/* Premium Workout Section */}
                  <div className="w-full lg:max-w-[60%] lg:flex-1 lg:pl-8 mb-4 lg:mb-0 order-first lg:order-last  pb-4 lg:pb-0">
                  ...
                  {/* Responsive Divider */}
                  <div className="w-full lg:w-[1px] h-[1px] lg:h-full bg-[#0d0d0d33] border-b border-[#0d0d0d33] border-opacity-20 border-solid lg:absolute lg:left-1/2 lg:top-0 lg:transform lg:-translate-x-1/2 my-4 lg:my-0" />

                  {/* Privacy Policy Section */}
                  <div className="w-full lg:text-left mt-4 lg:mt-0 lg:flex-1 lg:mr-1 order-last lg:order-first">
                    <p className="text-[9px] text-[#0d0d0dcc] mb-1 font-inter text-center lg:text-left">
                      Privacy Policy • Terms of Service • Sitemap • Accessibility • Do not sell or share my personal information
                    </p>
                    <p className="text-[10px] text-center lg:text-left font-semibold text-[#0d0d0dcc] font-inter">
