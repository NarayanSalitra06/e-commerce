...
const ProductFilterUsage: React.FC<ProductFilterProps> = ({
  ...
  return (
    <div className="h-full w-full flex flex-col lg:flex-row relative">
      ...
      {/* Filter Section */}
      <div className="w-full md:w-full lg:w-1/4 bg-white shadow-lg p-4 sm:h-auto md:h-[60vh] lg:h-[75vh] lg:absolute lg:right-10 lg:top-32 rounded-lg border-[#0d0d0d33] border border-solid border-opacity-60 lg:overflow-y-auto lg:z-20 hide-scrollbar overflow-x-hidden">
        {/* Small screens: Stack layout */}
        ...
        {/* Medium and Large screens: Grid layout - Kept exactly the same */}
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-1 gap-4">
          {/* Left Column (md) / Single Column (lg) */}
          <div className="md:row-span-1 lg:w-full">
            {/* Product Details */}
